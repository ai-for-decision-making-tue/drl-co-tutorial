...
def putInTheEnd(a, jobRdyTime_a, mchRdyTime_a, startTimesForMchOfa, opsIDsForMchOfa):
    # print('Yes!OK!')
    # The operation IDs are a reliable empty-slot marker even when a custom
    # environment configuration uses a different processing-time upper bound.
    index = np.where(opsIDsForMchOfa < 0)[0][0]
